--TEST--
decryptSoapDoc cleanup keeps Signature when sign-then-encrypt was used
--FILE--
<?php
...
$wsse->encryptSoapDoc($siteKey, $session, null, true);
...
echo ($xpath->query('//ds:Signature')->length === 1 ? 'SIG_OK' : 'SIG_FAIL')."\n";
?>
--EXPECTF--
BODY_OK
NO_DATA_REF
